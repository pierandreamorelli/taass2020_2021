...
import com.taass.ecommerce.controller.ProductController;
import com.taass.ecommerce.dto.OrderProductDto;
...
public class EcommerceApplicationIntegrationTest {
    ...
    private OrderController.OrderForm prepareOrderForm() {
        ...
        productDto.setProduct(new Product(1L, "TV Set", 300.00, ProductCategories.Component,"http://placehold.it/200x100",""));
